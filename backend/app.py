...
def create_app():
    ...
    for bp in [timeline_bp, stations_bp, explorer_bp, alerts_bp, report_bp, chat_bp, beaches_bp, live_bp, predict_bp, sentinel_bp, nasa_bp, predict_condition_bp, gee_bp]:
